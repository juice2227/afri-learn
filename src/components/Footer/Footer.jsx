...
const Footer = () => {
  return (
    <footer
      id="next-section"
      className="bg-black text-white py-12 transition duration-300 hover:shadow-lg"
    >
      <div className="container mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          <div className="flex items-center mb-4">
            ...
            >
              <img src={logo} alt="Logo" className="h-20 w-60 object-cover" />
            </a>
          </div>
          <p className="text-gray-300 italic mb-6 leading-relaxed">
            "Technology is not just a tool; it's a gateway to endless
            possibilities. Embrace the learning journey, for each line of code
            and every concept mastered unlocks a new dimension of innovation."
          </p>
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-2xl font-semibold mb-6 border-b border-gray-500 pb-2">
            Quick Links
          </h3>
        ...
        <div>
          ...
          <p className="text-gray-300 mb-4">
            <span className="font-semibold">Address:</span> Jomo Kenyatta
            Avenue, Sparki, Kenya
          </p>
          <p className="text-gray-300 mb-4">
      ...
      {/* Footer Bottom */}
      <div className="text-center py-6 mt-12 border-t border-red-700 shadow-md">
        <p className="text-sm">
          &copy; {new Date().getFullYear()} Afribot E-learning. All rights
          reserved.
        </p>
      </div>
    </footer>

    ...
    <div className="container mx-auto py-10 px-4 bg-black text-white">
      ...
      <div className="flex flex-col md:flex-row md:space-x-10 bg-white shadow-lg rounded-lg overflow-hidden p-5 md:p-10">
        ...
        <div className="md:w-1/2 flex flex-col justify-center p-5">
          <h3 className="text-2xl md:text-3xl font-semibold text-gray-800 mb-5">
            Our Mission
          </h3>
          <p className="text-gray-600 mb-5 leading-relaxed text-base md:text-lg">
            At our company, we strive to deliver the best services to our
            customers, empowering them through technology and innovative
            solutions. Our mission is to drive progress and make a meaningful
            impact in the lives of individuals and businesses.
          </p>

          <p className="text-gray-600 leading-relaxed mb-5 text-base md:text-lg">
            We believe in teamwork, collaboration, and a shared vision for
            success. Our dedicated team works tirelessly to provide exceptional
            service and support to our clients, ensuring their needs are met
